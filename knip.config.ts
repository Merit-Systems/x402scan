...
const config: KnipConfig = {
  ...
  ignoreIssues: {
    "apps/scan/src/components/ui/{accordion,alert-dialog,avatar,badge,button,card,collapsible,command,copy-button,data-list,data-table,dialog,dropdown-menu,field,input-group,input,interactive-row,label,logo,motion-tabs,origin-avatar,origin-summary,responsive-view,select,separator,sheet,sidebar,skeleton,sonner,spinner,stats-card,table,tabs,textarea,tooltip}.tsx":
      ["exports", "types"],
