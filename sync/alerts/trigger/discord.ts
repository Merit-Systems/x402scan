import type { BalanceCheckResult } from './balance-checker';
    ...
    body: JSON.stringify({
      ...
      embeds: [{
        ...
        fields: [
          ...
          { name: 'Current Balance', value: `$${parseFloat(balanceResult.balance).toFixed(2)} USDC`, inline: true },
          { name: 'Threshold', value: `$${balanceResult.threshold.toFixed(2)} USDC`, inline: true },
        ],
