...
CREATE MATERIALIZED VIEW IF NOT EXISTS stats_aggregated_0d AS
SELECT 
...
CREATE UNIQUE INDEX IF NOT EXISTS stats_aggregated_0d_idx
ON stats_aggregated_0d (facilitator_id, chain);

-- Bucketed view with 1-day buckets for all-time data
CREATE MATERIALIZED VIEW IF NOT EXISTS stats_buckets_0d AS
SELECT
...
CREATE UNIQUE INDEX IF NOT EXISTS stats_buckets_0d_idx
