...
export const env = createEnv({
  server: {
    ...
    CLICKHOUSE_HOST: z.url().optional(),
    CLICKHOUSE_USER: z.string().optional(),
    CLICKHOUSE_PASSWORD: z.string().optional(),
    CLICKHOUSE_DATABASE: z.string().optional(),
    TRANSFERS_CLICKHOUSE_HOST: z.url().optional(),
    TRANSFERS_CLICKHOUSE_USER: z.string().optional(),
    TRANSFERS_CLICKHOUSE_PASSWORD: z.string().optional(),
    TRANSFERS_CLICKHOUSE_DATABASE: z.string().optional(),
