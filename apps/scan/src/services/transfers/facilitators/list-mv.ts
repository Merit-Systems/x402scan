...
export const listTopFacilitatorsMvInputSchema = baseListQuerySchema({
...
const listTopFacilitatorsMVUncached = async (
  input: z.infer<typeof listTopFacilitatorsMvInputSchema>,
...
export const listTopFacilitatorsMV = createCachedPaginatedQuery({
  queryFn: listTopFacilitatorsMVUncached,
  cacheKeyPrefix: 'facilitators-list-mv',
