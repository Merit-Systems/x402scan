...
export const PartnerCollapsible = ({ onPartnerChange }: PartnerCollapsibleProps) => {
    ...
    }, [partnerName, partnerMeritContact, partnerEmail, partnerOrganization, onPartnerChange]);
                ...
                <div className="flex flex-row items-center gap-2">
                    <div className="flex-1 relative">
                        <Input
                            ...
                            className="w-full"
                        />
                        {searchPartner && !open && searchResults && searchResults.length > 0 && (
