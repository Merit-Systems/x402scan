      ...
      >
        <DialogHeader className="gap-2">
          <div className="flex justify-between gap-2 p-4">
            <div className="flex flex-row items-center gap-2">
              ...
              <div className="flex flex-col gap-2">
                <DialogTitle className=" ">Your Wallet</DialogTitle>
          ...
          <TabsList className="no-scrollbar w-full justify-start overflow-x-auto">
            ...
            <TabsTrigger value="wallet" appearance="default" className="">
              <Wallet className="size-4" /> Overview
            </TabsTrigger>
            <TabsTrigger value="deposit" appearance="default" className="">
              <ArrowDown className="size-4" /> Deposit
            </TabsTrigger>
            <TabsTrigger value="withdraw" appearance="default" className="">
