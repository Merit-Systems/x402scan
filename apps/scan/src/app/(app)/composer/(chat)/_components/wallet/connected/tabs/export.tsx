...
export const ExportWallet: React.FC<Props> = ({ address }) => {
      ...
      const { privateKey } =
        chain === Chain.SOLANA
          ...
          : await exportEvmAccount({
              evmAccount: ethereumAddressSchema.parse(address),
            });
  ...
  return (
    <div className="flex flex-col gap-4">
      {showConfirmation ? (
        <>
          <div className="flex items-start gap-3 rounded-lg border border-destructive-border bg-destructive-subtle p-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="type-supporting-body list-inside list-disc space-y-1 text-muted-foreground">
                <li>
        ...
        <>
          <div className="flex items-start gap-3 rounded-lg border border-warning-border bg-warning-subtle p-4">
            ...
            <div className="flex flex-col gap-2">
              <p className="type-supporting-body type-emphasis text-warning">
          ...
          <div className="flex flex-col gap-1">
            ...
            {isRevealed ? (
              ...
              <div className="rounded-md border bg-muted p-4 text-center">
                <p className="type-mono type-scale-supporting text-muted-foreground">
                  ••••••••
                </p>
              </div>
            )}
        ...
        <>
          <div className="flex items-center justify-between gap-1">
            <div className="flex items-center gap-1">
              ...
              />
              <span className="type-label">Export Wallet</span>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-lg border border-destructive-border bg-destructive-subtle p-4">
            <AlertTriangle className="mt-0.5 size-5 shrink-0 text-destructive" />
