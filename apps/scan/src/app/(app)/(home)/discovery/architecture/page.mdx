...
>
  <CopyPageDropdown
    ...
    pageUrl={`${env.NEXT_PUBLIC_APP_URL}/discovery/architecture`}
    markdownPath="/discovery/architecture.md"
  />
...
See [Server Discovery](/discovery/spec) for the full OpenAPI contract.
...
<DiscoveryDocActions
  secondaryHref="/discovery/spec"
  secondaryLabel="Read the discovery spec"
/>
