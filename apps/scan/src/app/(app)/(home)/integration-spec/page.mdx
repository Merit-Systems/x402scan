...
import { AgentPromptPreview } from "@/app/(app)/(home)/integration-spec/_components/agent-prompt-preview";
import { CopyForAgentsButton } from "@/app/(app)/(home)/integration-spec/_components/copy-for-agents-button";
