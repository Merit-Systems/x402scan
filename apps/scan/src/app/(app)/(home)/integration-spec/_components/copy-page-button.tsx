      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-64">
          ...
          <DropdownMenuItem
            render={
              <a
                href="/discovery/spec.md"
                aria-label="View integration specification as Markdown"
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-start gap-0.5 py-2"
              />
          ...
          <DropdownMenuItem
            render={
              <a
                ...
                aria-label="Open integration specification in Claude"
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-start gap-0.5 py-2"
              />
          ...
          <DropdownMenuItem
            render={
              <a
                ...
                aria-label="Open integration specification in ChatGPT"
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-start gap-0.5 py-2"
              />
