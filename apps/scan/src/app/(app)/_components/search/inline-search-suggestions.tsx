...
export const InlineSearchSuggestions: React.FC<Props> = ({
  ...
  return (
    <div className="absolute top-full right-0 left-0 z-50 mt-1 overflow-hidden rounded-md border bg-popover shadow-lg">
      {isSemanticMode ? (
        semanticLoading ? (
          ...
          <ul className="max-h-80 overflow-y-auto">
            <li className="px-3 pt-2 pb-1 text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase">
              Best matches
            </li>
