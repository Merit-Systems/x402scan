...
import { ClientIcon } from '@/app/(mcp)/mcp/_components/clients/icons';

import { clients } from '@/app/(mcp)/mcp/_components/clients/data';

import type { ReactNode } from 'react';
import type { Clients } from '@/app/(mcp)/mcp/_components/clients/data';
