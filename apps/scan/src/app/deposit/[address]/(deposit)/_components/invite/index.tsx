...
import { METHOD_METADATA } from '../methods/data';
...
export const InviteCodeRedemption: React.FC<Props> = ({
  address,
  setAccordionValue,
}) => {
  ...
  const methodMetadata = METHOD_METADATA[OnrampMethods.INVITE_CODE];
